  ...
  return (
    <div className="min-h-screen bg-zinc-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-2xl border border-zinc-200 shadow-sm p-8 text-center space-y-4">
        ...
        <h1 className="text-2xl font-semibold text-zinc-900">Signup is temporarily disabled</h1>
        <p className="text-zinc-600">
          Pick a username on the home page and join the chat without creating an account.
        </p>
        <Link
          href="/"
